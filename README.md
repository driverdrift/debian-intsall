...
If rescue-mode can't apt install packages due to outdated signature. Follow [these](https://github.com/driverdrift/linux-docs/blob/main/disk.md) steps to solve it.
